...
$(function(){
	...
	var shape="<s:property value='dog.shape' />";
	var color="<s:property value='dog.color' />";
	 $("#shape option").each(function(){
		if($(this).val()==shape){
		$(this).attr("selected","selected");
		}
	});
	 var colorStrs=color.split(",");
		 $(".color").each(function(){
			 var value=$(this).val();
			 for(var i=0;i<colorStrs.length;i++){
			 if(colorStrs[i].trim()==value){
				 this.checked=true;
			 }
			 }
	 });
...
<body>
    ...
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" id="click1" class="selected">犬类</a></li> 
  	</ul>
    </div> 
    
  	<div id="tab1" class="tabson">
  	 <form action="modifyPetsPetsAction.action" enctype="multipart/form-data" id="formSubmit" method="post">
    ...
    <tr >
    	...
    	<s:if test="dog.petsType.id==#dogs.id">
	    <option value="<s:property value="#dogs.id"/>" selected="selected"><s:property value="#dogs.smallType"/></option>
    	</s:if>
    	<s:else>
    	...
    	<td height="20px">
    	<input name="dog.life" type="text" value="<s:property value="dog.life"/>" class="dfinput check" onblur="numberCheck(this)" />
    	</td>
    </tr>
     <tr >
    ...
    <tr >
    	...
    	<td height="20px">
    	<cite>
    	<s:if test="dog.sex=='雄性'">
    	<input name="dog.sex" type="radio" value="雄性" checked="checked" />雄性&nbsp;&nbsp;&nbsp;&nbsp;<input name="dog.sex" type="radio" value="雌性" />雌性
    	</s:if>
    	<s:if test="dog.sex=='雌性'">
    	<input name="dog.sex" type="radio" value="雄性" />雄性&nbsp;&nbsp;&nbsp;&nbsp;<input name="dog.sex" type="radio" value="雌性"  checked="checked" />雌性
    	</s:if>
    	</cite>
    	</td>
    	<td height="20px">
    	...
    	<td height="20px">
    	<input name="dog.height" type="text" value="<s:property value="dog.height"/>" class="dfinput check" onblur="numberCheck(this)"/>
    	</td>
    </tr>
     <tr >
    	<td height="10px" colspan="4">
     ...
     <tr >
    	...
    	<td height="20px">
    	<input name="dog.width" type="text" value="<s:property value="dog.width"/>" class="dfinput check"  onblur="numberCheck(this)" />
    	</td>
    	<td height="20px">
    	<label>毛长: </label>
    	</td>
    	...
    	<s:if test="dog.woolLength=='长毛'">
	    <option value="长毛" selected="selected">长毛</option>
	    <option value="短毛">短毛</option>
    	</s:if>
    	<s:else>
    	<option value="长毛" >长毛</option>
	    <option value="短毛" selected="selected">短毛</option>
    	</s:else>
	    </select>
    	</td>
    </tr>
     ...
     <tr >
    	...
    	<td height="20px">
    	<input type="checkbox" value="黑" name="dog.color" class="color" />&nbsp;黑色 &nbsp;&nbsp;
    	<input type="checkbox" value="棕" name="dog.color" class="color" />&nbsp;棕色 &nbsp;&nbsp;
    	<input type="checkbox" value="白" name="dog.color" class="color"/>&nbsp;白色 &nbsp;&nbsp;
    	<input type="checkbox" value="黄" name="dog.color" class="color"/>&nbsp;黄色 &nbsp;&nbsp;
    	</td>
    	<td height="20px">
    	<label>体型: </label>
    	</td>
    	<td height="20px">
    	<select name="dog.shape" id="shape" class="select1">
     ...
     <tr >
    	...
    	<td height="20px">
    	<input name="dog.salePrice" type="text" value="<s:property value="dog.salePrice"/>" id="money" class="dfinput money" />
    	</td>
    	<td height="20px">
    	<label>库存: </label>
    	</td>
    	<td height="20px">
    	<input name="dog.count" type="text" class="dfinput check" value="<s:property value="dog.count"/>" onblur="numberCheck(this)" />
    	</td>
    </tr>
     <tr >
    	<td height="10px" colspan="4">
    ...
    <tr >
    	...
    	<td  colspan="3" >
    	<textarea name="dog.describe" cols="" rows="" id="describe" class="textinput des"><s:property value="dog.describe"/></textarea>
    	<input type="hidden" name="dog.defaultPicture"   value ="<s:property value="dog.defaultPicture"/>" /><br />
    	</td>
    	<%--<td  >
    	<input type="file"/>
    	</td>
    ...
    <th colspan="1">
    	...
    	<input type="file" name="photo" id="uploadFile"  onchange="showPic(this)" /><br />
    	</td>
    </tr>
