...
<body style="background:#f0f9fd;">
    ...
    <dd>
    <div class="title">
    <span><img src="<%=path %>/background/assets/images/leftico02.png" /></span>用户管理
    </div>
    <ul class="menuson">
        <li><cite></cite><a href="user_add.jsp" target="rightFrame">添加用户</a><i></i></li>
        <li><cite></cite><a href="queryAllmanagerAction.action?resultFlg=&pageBean.currentPage=1" target="rightFrame">查询用户</a><i></i></li>
        <li><cite></cite><a href="queryHistoryLhAction.action" target="rightFrame">用户履历</a><i></i></li>
        </ul>     
    </dd> 
