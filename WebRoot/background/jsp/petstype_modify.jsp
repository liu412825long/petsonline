...
<script type="text/javascript">
	$(function(){
		...
		$("#returnbtn").click(function(){
			location.href="queryPageBeanptAction.action?resultFlg=&currentPage=<s:property value="pageBean.currentPage"/>";
		});
	});
...
<body>
	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div class="itab">
				<ul>
					<li><a href="#tab1" class="selected">修改宠物类型</a>
					</li>
				</ul>
			</div>

			<form action="updateptAction.action"
				onsubmit="return isSubmit();" method="post">
				<div id="tab1" class="tabson">
				<input type="hidden" value="petsType.id" />
					...
					<ul class="forminfo">
							...
							<div class="usercity">
								...
								<div class="cityleft">
									<select class="select2" name="petsType.bigType">
										...
										<s:if test="petsType.bigType==#btl.bigType">
											<option selected="selected" value="<s:property value="#btl.bigType" />" >
												<s:property value="#btl.bigType" />
											</option>
										</s:if>
										<s:else>
											<option  value="<s:property value="#btl.bigType" />" >
												<s:property value="#btl.bigType" />
											</option>
										</s:else>
										</s:iterator>
						...
						<li><label>小分类<b>*</b>
							...
							id="smallTypeInput" value="<s:property value="petsType.smallType"/>" style="width:518px;" /><font
							id="smallType" color="red"></font>
						</li>
						<li><label>原产地<b>*</b>
						</label><input type="text" name="petsType.home" class="dfinput"
							id="homeInput" value="<s:property value="petsType.home"/>" style="width:518px;" /><font id="home"
							color="red"></font>
						</li>

						<li><label>宠物档案<b>*</b>
						</label> <textarea class="textinput" name="petsType.typeIntroduce"><s:property value="petsType.typeIntroduce"/></textarea>
						</li>
						<li><label>&nbsp;</label><input name="" type="submit" id="btn" class="btn" value="确定修改" />
						<input name="" type="button" id="returnbtn" class="btn" value="返回" />
						</li>
					</ul>
